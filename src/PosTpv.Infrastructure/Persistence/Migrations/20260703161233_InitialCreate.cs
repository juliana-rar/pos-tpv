    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExtraProduct", x => new { x.ExtrasId, x.ProductsId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ExtraProduct_Products_ProductsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VatTotal = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExtraProduct_ProductsId",
                table: "ExtraProduct",
                column: "ProductsId");
